...
const invalidUserError = new Error('That token is no longer associated with a user')
...
module.exports = { missingTokenError, invalidTokenError, invalidUserError, authorizationError }